...
var (
	...
	// returned when ant numbers surpass a given value, default is 1000 ants
	ErrMaxAntNumExceeded = errors.New("MaxAntNumExceeded: number of ants exceeded try lower than %d")

	// returned when the number of ants is 0
